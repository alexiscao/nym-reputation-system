...
The main goal of the simulations is to analyze how baseline staking attack compares with framing attack in terms of the costs to achieve an attack objectve. The analysis includes the following four main parts.
